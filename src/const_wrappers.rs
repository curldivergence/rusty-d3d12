...
pub const CONSTANT_BUFFER_DATA_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_CONSTANT_BUFFER_DATA_PLACEMENT_ALIGNMENT as u64);
...
pub const CS_4_X_RAW_UAV_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_CS_4_X_RAW_UAV_BYTE_ALIGNMENT as u64);
...
pub const DEFAULT_MSAA_RESOURCE_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_DEFAULT_MSAA_RESOURCE_PLACEMENT_ALIGNMENT as u64);
pub const DEFAULT_RENDER_TARGET_ARRAY_INDEX: u32 =
    D3D12_DEFAULT_RENDER_TARGET_ARRAY_INDEX;
pub const DEFAULT_RESOURCE_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_DEFAULT_RESOURCE_PLACEMENT_ALIGNMENT as u64);
...
pub const IA_DEFAULT_INDEX_BUFFER_OFFSET: ByteCount =
    ByteCount(D3D12_IA_DEFAULT_INDEX_BUFFER_OFFSET_IN_BYTES as u64);
pub const IA_DEFAULT_PRIMITIVE_TOPOLOGY: u32 =
    D3D12_IA_DEFAULT_PRIMITIVE_TOPOLOGY;
pub const IA_DEFAULT_VERTEX_BUFFER_OFFSET: ByteCount =
    ByteCount(D3D12_IA_DEFAULT_VERTEX_BUFFER_OFFSET_IN_BYTES as u64);
...
pub const RAW_UAV_SRV_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAW_UAV_SRV_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_AABB_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_AABB_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_ACCELERATION_STRUCTURE_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_INSTANCE_DESCS_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_INSTANCE_DESCS_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_MAX_ATTRIBUTE_SIZE: ByteCount =
    ByteCount(D3D12_RAYTRACING_MAX_ATTRIBUTE_SIZE_IN_BYTES as u64);
...
pub const RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_SHADER_RECORD_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_SHADER_TABLE_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_SHADER_TABLE_BYTE_ALIGNMENT as u64);
pub const RAYTRACING_TRANSFORM3X4_BYTE_ALIGNMENT: ByteCount =
    ByteCount(D3D12_RAYTRACING_TRANSFORM3X4_BYTE_ALIGNMENT as u64);
...
pub const REQ_MULTI_ELEMENT_STRUCTURE_SIZE: ByteCount =
    ByteCount(D3D12_REQ_MULTI_ELEMENT_STRUCTURE_SIZE_IN_BYTES as u64);
...
pub const SHADER_IDENTIFIER_SIZE: ByteCount =
    ByteCount(D3D12_SHADER_IDENTIFIER_SIZE_IN_BYTES as u64);
...
pub const SMALL_MSAA_RESOURCE_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_SMALL_MSAA_RESOURCE_PLACEMENT_ALIGNMENT as u64);
pub const SMALL_RESOURCE_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_SMALL_RESOURCE_PLACEMENT_ALIGNMENT as u64);
pub const SO_BUFFER_MAX_STRIDE: ByteCount =
    ByteCount(D3D12_SO_BUFFER_MAX_STRIDE_IN_BYTES as u64);
pub const SO_BUFFER_MAX_WRITE_WINDOW: ByteCount =
    ByteCount(D3D12_SO_BUFFER_MAX_WRITE_WINDOW_IN_BYTES as u64);
...
pub const TEXTURE_DATA_PITCH_ALIGNMENT: ByteCount =
    ByteCount(D3D12_TEXTURE_DATA_PITCH_ALIGNMENT as u64);
pub const TEXTURE_DATA_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_TEXTURE_DATA_PLACEMENT_ALIGNMENT as u64);
pub const TILED_RESOURCE_TILE_SIZE: ByteCount =
    ByteCount(D3D12_TILED_RESOURCE_TILE_SIZE_IN_BYTES as u64);
pub const TRACKED_WORKLOAD_MAX_INSTANCES: u32 =
    D3D12_TRACKED_WORKLOAD_MAX_INSTANCES;
pub const UAV_COUNTER_PLACEMENT_ALIGNMENT: ByteCount =
    ByteCount(D3D12_UAV_COUNTER_PLACEMENT_ALIGNMENT as u64);
...
pub const VIDEO_DECODE_MIN_BITSTREAM_OFFSET_ALIGNMENT: ByteCount =
    ByteCount(D3D12_VIDEO_DECODE_MIN_BITSTREAM_OFFSET_ALIGNMENT as u64);
pub const VIDEO_DECODE_MIN_HISTOGRAM_OFFSET_ALIGNMENT: ByteCount =
    ByteCount(D3D12_VIDEO_DECODE_MIN_HISTOGRAM_OFFSET_ALIGNMENT as u64);
